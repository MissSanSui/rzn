...
(function ($) {
    ...
    Calendar.prototype = {
        ...
        _initializeOptions: function (opt) {
            ...
            this.options = {
                ...
                renderHeader: opt.renderHeader != null ? opt.renderHeader : true
            };
        ...
        _renderHeader: function () {
            ...
            header.addClass('workCalendar-header panel panel-default');
        ...
        _applyEvents: function () {
            ...
            this.element.find('.workCalendar-header .prev').click(function () {
                if (!$(this).hasClass('disabled')) {
            ...
            this.element.find('.workCalendar-header .next').click(function () {
                if (!$(this).hasClass('disabled')) {
                    _this.element.find('.months-container').animate({'margin-left': '-100%'}, 100, function () {
                        _this.element.find('.months-container').hide();
                        _this.element.find('.months-container').css('margin-left', '0');
        ...
        _openContextMenu: function (elt) {
            ...
            if (contextMenu.length > 0) {
                ...
                contextMenu.addClass('workCalendar-context-menu');
    ...
    $(function () {
        $('[data-provide="workCalendar"]').each(function () {
            $(this).calendar();
        });
    });
}(window.jQuery));